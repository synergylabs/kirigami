"""
Code adapted from https://github.com/speechbrain/speechbrain
...
def create_csv(
    ...
    for wav_file in wav_lst:
        ...
        # Retrieving word and check for uppercase
        if uppercase:
            wrd_file = wav_file.replace(".WAV", ".WRD")
        else:
            wrd_file = wav_file.replace(".wav", ".wrd")

        wrd_file = wrd_file.replace(".WRD.wav", ".WRD")
